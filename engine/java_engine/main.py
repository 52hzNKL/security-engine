...
from java_engine.scanner import run_semgrep, run_gitleaks


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Runtime Java security scanning engine"
    )
    ...
    parser.add_argument(
        "--report-output",
        default="java_scan_report.json",
        help="Path to output runtime scan report",
    )
    parser.add_argument(
        "--metrics-output",
        default="java_scan_metrics.json",
